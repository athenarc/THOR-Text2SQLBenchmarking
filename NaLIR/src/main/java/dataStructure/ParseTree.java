...
public class ParseTree implements Serializable
{
	...
	public String toString() 
	{
		...
		while(!nodeList.isEmpty())
		{
			...
			result += "<" + curNode.label + ", " + curNode.pos + ", " + curNode.tokenType + ", " +
						  curNode.relationship + ", #ME :" + curNode.mappedElements.size() + ", map= " +
						  ((curNode.getChoiceMap() != null) ? (curNode.getChoiceMap().printForCheck()): "null") +  "\n"; 

						
			// for (MappedSchemaElement me: curNode.mappedElements)
			// 	result += me.printForCheck() + "\n";
