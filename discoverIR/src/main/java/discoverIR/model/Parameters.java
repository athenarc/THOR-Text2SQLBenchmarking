...
public class Parameters {
    ...
    public ExecutionEngineAlgorithms executionEngineAlgorithm;
    ...
    public Parameters(ParametersBuilder builder) {
        ...
        this.executionEngineAlgorithm   = builder.executionEngineAlgorithm;
	...
	public static class ParametersBuilder {
        ...
        int maxTuples;
        int maxNetworksSize;
        ExecutionEngineAlgorithms executionEngineAlgorithm;		

        public ParametersBuilder(){            
            // Initialize with default Values.
            this.keywords = null;
            this.printResultsOrderedByTable = true;
            this.executionEngineAlgorithm = ExecutionEngineAlgorithms.Naive;            
        ...
        // Set the int maxNetworksSize.
        public ParametersBuilder setExecutionEngineAlgorithm(ExecutionEngineAlgorithms executionEngineAlgorithm) {
			this.executionEngineAlgorithm = executionEngineAlgorithm;
			return this;
        }
